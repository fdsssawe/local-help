...
const page = () => {
    return (
        <div className='w-full h-screen flex pt-10 flex-col items-center relative'>
            <div className='hidden flex-col border-box min-w-[180px] border w-[180px] pr-6 gap-4 items-start lg:flex absolute top-[15%] left-[14.5%]'>
                <Link href="#header_invoice" className='text-base-subtle text-sm font-semibold leading-5'>fsdfsd</Link>
                <Link href="#products" className='text-base-subtle text-sm font-semibold leading-5'>fsdfsd</Link>
                <Link href="#attachments" className='text-base-subtle text-sm font-semibold leading-5'>fdsf</Link>

...
export default function Header() {
    ...
    return (
        ...
        <div className="container mx-auto flex flex-wrap p-5 py-2 flex-row items-center">
            ...
            <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center font-[350] flex-1">
            <SignedIn>
            ...
            <div className='relative overflow-hidden w-7 h-7 flex-1 flex justify-end'>
            <SignedIn>
            <UserButton />
